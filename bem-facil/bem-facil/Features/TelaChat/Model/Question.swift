...
struct Question {
    ...
    static let mockQuestionsPatterns: [Question] = [
        Question(
            pattern: "bolsa jovem|como recebo o bolsa jovem",
        ...
        Question(
            pattern: "beneficios|quais beneficios tenho direito sendo baixa renda|baixa renda",
        ...
        Question(
            pattern: "dignidade menstrual|como acessar dignidade menstrual",
        ...
        Question(
            pattern: "bolsa familia|como receber bolsa familia",
        ...
        Question(
            pattern: "juventude digital|como participar juventude digital",
        ...
        Question(
            pattern: "auxilio gas|como solicitar auxilios gas| gás| Gas",
        ...
        Question(
            pattern: "farmacia popular|como utilizar farmacia popular",
        ...
        Question(
            pattern: "pé de meia|como funciona o pé de meia",
